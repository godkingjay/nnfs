...
# Create Loss Function, Categorical Cross-Entropy
loss1 = Loss_CategoricalCrossEntropy()
loss_value1 = loss1.calculate(activation2.outputs, y)

# Create Accuracy function
accuracy1 = Accuracy()
accuracy_value1 = accuracy1.calculate(activation2.outputs, y)
